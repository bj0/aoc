...
class Pt(_coconut.collections.namedtuple("Pt", "x y")):
    ...
    def __add__(self, other):
        return _coconut_tail_call((Pt), *map(_coconut.operator.add, self, other))

    @_coconut_tco
    def __sub__(self, other):
        return _coconut_tail_call((Pt), *map(_coconut_minus, self, other))

    @_coconut_tco
    def __hash__(self):
        return _coconut_tail_call(tuple.__hash__, self)
    ...
    @_coconut_tco
    def nb4(self):
        return _coconut_tail_call(map, lambda t: Pt(*t), map(_coconut.functools.partial(_coconut.operator.add, self), Pt.directions()))
