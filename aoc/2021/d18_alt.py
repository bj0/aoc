# this alt uses a flat list of (value, depth) instead of a tree.  it lets the operations be linear list traversals
# instead of recursive tree traversals
# from https://github.com/Gravitar64/Advent-of-Code-2021/blob/main/Tag_18.py
